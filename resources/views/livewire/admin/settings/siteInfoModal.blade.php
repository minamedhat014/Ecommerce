...
<x-app-modal id="addModel" type="store" title="Add to this list">
  <x-slot name="inputs">
   ...
   <x-form-input type="text" fname="Slogan" bname="slogan" icon="fa-solid fa-file" class="req" />
   <x-form-input type="text" fname="Hero video link" bname="video_link" icon="fa-solid fa-file" class="req" />
...
<x-app-modal id="addHeroModal" type="addHeroImage" title="add hero image">
  <x-slot name="inputs">
    <x-form-photo fname="Hero image" bname="photo"> 
      <x-slot name="preview">
        <x-photo-preview :previews="$uploadedPreview" removeAction="removePhoto" />
      </x-slot>
    </x-form-photo>
