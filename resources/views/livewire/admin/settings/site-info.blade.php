     ...
     @endcan
      ...
      <x-slot name="body">
                 @foreach($this-> data as $row)
                            ...
                            <td> 
                              <img src="{{$row->getFirstMediaUrl('site hero')}}" alt="{{ $row->slogan }}"  class="profile">
                          </td>
                            <td>{{$row->slogan}}</td>
                             ...
                             <td>  
                              <div>
                                ...
                                <div class="dropdown-menu">       
                                  ...
                                  <li><a data-bs-toggle="modal" class="dropdown-item"data-bs-target="#addHeroModal" type="button"   wire:click='gettingId({{$row->id}})' > <i class="fa-solid fa-image"></i> Add Hero Image </a></li> 
                                </div>
                              </div>
                             </td>
                             @endcan
